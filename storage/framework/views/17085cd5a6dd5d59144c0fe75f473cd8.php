<?php $__env->startSection('title', 'Dashboard UTS Laravel Project'); ?>
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body text-center p-4 d-flex flex-column">
                ...
                <div class="mt-auto">
                    <a href="<?php echo e(route('pengelolaan', request()->query())); ?>" class="btn btn-primary w-100">
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body text-center p-4 d-flex flex-column">
                ...
                <div class="mt-auto">
                    <a href="<?php echo e(route('profile', request()->query())); ?>" class="btn btn-info w-100">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\reyy\laragon\www\UTS_PWEB_232410101091\resources\views/dashboard.blade.php ENDPATH**/ ?>