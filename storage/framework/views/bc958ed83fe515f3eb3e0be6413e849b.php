<?php $__env->startSection('title', 'Profile UTS Laravel Project'); ?>
        ...
        <div class="card border-0">
            <div class="card-body p-4 text-center">
                <div class="position-relative mb-4 mx-auto" style="width: 150px;">
                    <img src="<?php echo e(asset('FOTOPROFIL.jpg')); ?>" class="img-fluid rounded-circle border shadow-sm" alt="Profile Picture"
        ...
        <div class="card border-0 mb-4">
            ...
            <div class="card-body p-4">
                <div class="alert alert-primary bg-primary bg-opacity-10 border-0">
                    <div class="d-flex">
                        <div>
                            <h6 class="fw-bold mb-1" style="color: #fff8f8;">Selamat datang, <?php echo e($username); ?>!</h6>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-9">
                        <p class="mb-0 fw-medium"><?php echo e(date('d F Y')); ?></p>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\reyy\laragon\www\UTS_PWEB_232410101091\resources\views/profile.blade.php ENDPATH**/ ?>